...
const getPaymentLink = AsyncHandler(async (req, res) => {
    ...
    const paymentLink = paymentStatusResult.link_url;

    return res.status(200).json(new ApiResponse(200, paymentLink, "Payment link fetched successfully"));
});

export { placeOrderViaCart, getOrders, updateOrderStatus, getPaymentLink };
